...
public class TableSorter extends TableMap {
    ...
    public void checkModel() {
        if (indexes.length != model.getRowCount()) {
            logger.log(Level.WARNING,"Sorter not informed of a change in model.");
        }
    }
    ...
    public Object getValueAt(int aRow, int aColumn) {
		...
		public int redirectRow(int aRow) {
			checkModel();
			return indexes[aRow];
		}
    ...
    public void sortByColumn(int column) {
		...
		public void resortOnLastColumn() {
			if (lastColumn != -1) {
				sortByColumn(lastColumn, lastAscending);
			}
		}
