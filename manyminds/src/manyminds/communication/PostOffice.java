 ...
 *
 *  <b>This method doesn't do anything at all</b>  It needs to be implemented.  Right now, the way
 * mailboxes get unregistered is by having them go stale.  When the PostOffice can't successfully
 * deliver mail to a mailbox, it stops trying
 *
