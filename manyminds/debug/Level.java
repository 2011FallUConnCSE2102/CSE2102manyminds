...
public class Level implements Serializable {
    ...
    public static Level parse( String name ) {
        ...
        try {
            ...
            if ( retval == null ) {
                throw new IllegalArgumentException( "Integer value passed does not corresponding to any predefined Level!" );
            }
            return retval;
        }
        catch ( NumberFormatException nfe ) {
            throw new IllegalArgumentException( "Provided name not a level name and not parseable as an integer!" );
        }
    }
